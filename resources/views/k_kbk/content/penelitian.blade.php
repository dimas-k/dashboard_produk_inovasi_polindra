                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('edit.penelitian', $p->id) }}"
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div>
                                                            <input type="radio" id="penulisKorespondensiDosen_{{ $p->id }}" name="penulis_korespondensi_type"
                                                                value="dosen" onclick="togglePenulisKorespondensiInput({{ $p->id }})">
                                                            <label for="penulisKorespondensiDosen_{{ $p->id }}">Dosen</label>
                                                            <input type="radio" id="penulisKorespondensiNonDosen_{{ $p->id }}" name="penulis_korespondensi_type"
                                                                value="non_dosen" onclick="togglePenulisKorespondensiInput({{ $p->id }})">
                                                    ...
                                                    <div class="row" id="dosenInput_{{ $p->id }}">
                                                        <div class="col mb-6">
                                                            <label for="penulis_korespondensi_select_{{ $p->id }}" class="form-label">Nama Penulis Korespondensi</label>
                                                            <select class="selectpicker w-70" data-live-search="true" id="penulis_korespondensi_select_{{ $p->id }}"
                                                                name="penulis_korespondensi_select" title="Pilih penulis..">
                                                                <option value="" selected>None</option>
                                                                <optgroup label="Ketua KBK">
                                                                    @foreach ($penulisU as $penulis)
                                                                        <option value="{{ $penulis->nama_lengkap }}">
                                                    ...
                                                    <!-- Input untuk Non-Dosen -->
                                                    <div class="row" id="nonDosenInput_{{ $p->id }}" style="display: none;">
                                                        <div class="col mb-6">
                                                            <label for="penulis_korespondensi_lainnya_{{ $p->id }}" class="form-label">Nama Penulis Korespondensi Lainnya</label>
                                                            <input type="text" id="penulis_korespondensi_lainnya_{{ $p->id }}" class="form-control"
                                                                placeholder="Masukkan nama Penulis Korespondensi lainnya" name="penulis_korespondensi_lainnya" />
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col mb-6">
                                                    ...
                                                    <div class="row">
                                                        <div class="col mb-6"
                                                            ...
                                                            <label class="form-label"
                                                                for="anggota_penulis_lainnya_{{ $p->id }}">Nama
                                                                Anggota
                                                                Lainnya</label>
                                                            <textarea id="anggota_penulis_lainnya_{{ $p->id }}" name="anggota_penulis_lainnya" class="form-control"
                                                                placeholder="Masukkan Nama Anggota Penulis lainnya"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col mb-6">
                                                            <label for="anggota_penulis_{{ $p->id }}">Pilih
                                                                Anggota Penulis</label>
                                                            <select class="selectpicker w-50" data-live-search="true"
                                                                id="anggota_penulis_{{ $p->id }}"
                                                                name="anggota_penulis[]" multiple
                                                                title="Pilih Anggota Penulis..">
                                                                <optgroup label="Ketua KBK">
                                                                    @foreach ($penulisU as $penulis)
                                                                        <option value="user_{{ $penulis->id }}">
