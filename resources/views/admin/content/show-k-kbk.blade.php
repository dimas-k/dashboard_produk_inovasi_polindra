<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card p-2">
        ...
        <img src="{{ asset('storage/'. $k_kbk->pas_foto) }}" class="rounded-circle mx-auto d-block mb-5 mt-2" alt="" style="width: 140px; height: 140px; border-radius: 70%; object-fit: cover;">
